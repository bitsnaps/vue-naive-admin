...
/**
 * * IFNULL function similar to MySQL
 * * The first parameter is NULL/UNDEFINED/'' Backs the second parameter as a backup value, otherwise the first parameter will be returned
